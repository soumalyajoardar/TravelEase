...
import { getAdminArticles, HelpArticle } from '@/services/helpService';
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 p-4 md:p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-primary">Help Center Content</h1>
          <p className="text-secondary mt-1">Manage articles, categories, and FAQs.</p>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-border overflow-hidden">
        <div className="p-4 border-b border-border bg-gray-50 flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-4">
          ...
          <select disabled={isLoading || articles.length === 0} className="w-full sm:w-auto border border-border rounded px-3 py-2 text-sm bg-white text-secondary">
        ...
        <div className="overflow-x-auto min-h-[400px] flex flex-col">
          {isLoading ? (
            ...
            <div className="flex-1 flex items-center justify-center p-8">
              <AdminEmptyState 
                icon={HelpCircle}
                title="No help articles have been published yet."
                description="Write articles to help customers resolve issues independently."
