...
import { getFares } from '@/services/supabaseAdminService';
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 p-4 md:p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-primary">Fares</h1>
          <p className="text-secondary mt-1">Manage pricing, taxes, and service fees.</p>
        </div>
        ...
        <div className="overflow-x-auto min-h-[400px] flex flex-col">
          {isLoading ? (
            ...
            <div className="flex-1 flex items-center justify-center p-8">
              <AdminEmptyState 
                icon={DollarSign}
                title="No fare information has been added yet."
                description="Configure base fares and taxes for your active services."
            ...
            <table className="w-full text-left text-sm whitespace-nowrap">
              <thead className="bg-gray-50 border-b border-border text-secondary">
                <tr>
                  ...
                  <th className="px-6 py-3 font-medium uppercase tracking-wider text-xs">Class</th>
                  <th className="px-6 py-3 font-medium uppercase tracking-wider text-xs">Base Fare</th>
                  <th className="px-6 py-3 font-medium uppercase tracking-wider text-xs">Total</th>
