...
import { getAvailability } from '@/services/supabaseAdminService';
    ...
    <div className="max-w-6xl mx-auto space-y-6 p-4 md:p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-secondary mt-1">Manage seat and berth allocations for upcoming schedules.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-border overflow-hidden">
        <div className="p-4 border-b border-border bg-gray-50 flex items-center space-x-4">
          <div className="relative flex-1 max-w-sm">
            ...
            <input 
              type="text" 
              placeholder="Search by schedule or route..." 
          ...
          {isLoading ? (
            ...
            <div className="flex-1 flex items-center justify-center p-8">
              <AdminEmptyState 
                ...
                description="Seat inventory will be generated when schedules are published and bookings are made."
            ...
            <table className="w-full text-left text-sm whitespace-nowrap">
              <thead className="bg-gray-50 border-b border-border text-secondary">
                <tr>
                  <th className="px-6 py-3 font-medium uppercase tracking-wider text-xs">Schedule</th>
                  <th className="px-6 py-3 font-medium uppercase tracking-wider text-xs">Service</th>
                  <th className="px-6 py-3 font-medium uppercase tracking-wider text-xs">Class/Type</th>
                  <th className="px-6 py-3 font-medium uppercase tracking-wider text-xs">Total Seats</th>
                  <th className="px-6 py-3 font-medium uppercase tracking-wider text-xs">Available</th>
